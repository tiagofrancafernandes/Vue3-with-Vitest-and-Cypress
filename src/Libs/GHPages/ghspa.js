/**
 * Download at: 2025-01-31
 * Download from: https://github.com/websemantics/gh-pages-spa/blob/0e27ea5ef0ef40520154bc19b3c9dea05885b27d/ghspa.js
...
(function (l, projectPages) {
    if (l?.host?.endsWith('.github.io')) {
        return;
    }

    let repo = projectPages ? '/' + l.pathname.split('/')[1] : '';
